...
class MissionsController extends AbstractController
{
    ...
    #[Route('/{alias}', name: 'missions_show', methods: ['GET'])]
    ...
    #[Route('/{alias}/edit', name: 'missions_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{alias}', name: 'missions_delete', methods: ['POST'])]
    public function delete(Request $request, Missions $mission): Response
    {
        if ($this->isCsrfTokenValid('delete'.$mission->getAlias(), $request->request->get('_token'))) {
            $entityManager = $this->getDoctrine()->getManager();
